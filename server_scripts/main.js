ServerEvents.recipes(event => {
  ...
  event.replaceOutput({}, 'forbidden_arcanus:wax', 'productivebees:wax')
  event.replaceInput({}, 'forbidden_arcanus:wax', 'productivebees:wax')
  ...
  event.custom({
    ...
    ingredients: [
      {
        type: "fluid_stack",
        amount: 250,
        fluid: "mechanical_botany:void_compost",
      },
      {
    ...
    results: [
      ...
      {
        count: 1,
        id: "forbidden_arcanus:yellow_orchid",
      },
    ],
  });
    ...
    ingredients: [
      {
        type: "fluid_stack",
        amount: 250,
        fluid: "mechanical_botany:compost",
      },
      {
        item: "eternal_starlight:torreya_sapling",
      },
    ],
    processing_time: 6200,
    results: [
      {
        count: 2,
        id: "eternal_starlight:torreya_vines",
      },
      {
        count: 1,
        id: "eternal_starlight:torreya_sapling",
      },
    ],
  });
